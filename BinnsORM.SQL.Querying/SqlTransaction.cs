...
namespace BinnsORM.SQL.Querying
{
    ...
    { 
        ...
        {
            return AddQueryText(select.ToString());
        }


        public SqlTransaction Insert<T>(T entity) where T : BinnsORMTableBase
        {
        ...
        public SqlTransaction InsertList<T>(IEnumerable<T> entities) where T : BinnsORMTableBase
        {
        ...
        public SqlTransaction Update<T>(T entity) where T : BinnsORMTableBase
        {
        ...
        public SqlTransaction UpdateList<T>(IEnumerable<T> entities) where T : BinnsORMTableBase
        {
            foreach (T entity in entities)
            {
                Update(entity);
        ...
        public SqlTransaction Delete<T>(T entity) where T : BinnsORMTableBase
        {
        ...
        public SqlTransaction DeleteList<T>(IEnumerable<T> entities) where T : BinnsORMTableBase
        {
            foreach (T entity in entities)
            {
                Delete(entity);
        ...
        public int Execute(bool commitTransaction)
        {
            ...
            return SqlQueryInterface.ExecuteNonQueryText(transactionSql);
        }
